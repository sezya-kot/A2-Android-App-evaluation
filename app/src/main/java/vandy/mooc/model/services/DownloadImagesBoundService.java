...
public class DownloadImagesBoundService
			...
			final Runnable downloadImageAndReply =
					new Runnable() {
						...
						public void run() {
							...
							// TODO 15 -- you fill in here.
							Context context = mService.get().getApplicationContext();
							Uri pathToImageFile = NetUtils.downloadImage(context, imageUrl, directoryPathname);
							// Send the path to the image file, url, and
							// requestCode back to the Activity via the
							// replyMessenger.
							// TODO 16 -- you fill in here.
							sendPath(replyMessenger, pathToImageFile, imageUrl, requestCode);
						}
					};

			// Execute the downloadImageAndReply Runnable to download
			// the image and reply.
			// TODO 17 -- you fill in here.
	...
	public static Intent makeIntent(Context context) {
		...
		// TODO 21 -- you fill in here, replacing null with the proper
		// code.
