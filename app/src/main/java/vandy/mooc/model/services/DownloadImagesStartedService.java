...
public class DownloadImagesStartedService
    ...
    public static Intent makeIntent(Context context,
        ...
        // TODO 25 -- you fill in here, replacing "null" with the proper
        ...
        Message requestMessage = RequestMessage.makeRequestMessage(requestCode, url, directoryPathname, replyMessenger).getMessage();

        Intent intent = new Intent(context, DownloadImagesStartedService.class);
        intent.putExtra(REQUEST_MESSAGE, requestMessage);
    ...
    private void sendPath(Messenger messenger,
        ...
        try {
            ...
            // TODO 32 -- you fill in here.
            Message replyMessageData = replyMessage.getMessage();
            messenger.send(replyMessageData);
