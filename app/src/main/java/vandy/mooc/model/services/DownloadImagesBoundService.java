			...
			final Runnable downloadImageAndReply =
					new Runnable() {
						...
						public void run() {
							...
							// TODO -- DONE? you fill in here.
							Uri imagePathname = NetUtils.downloadImage(null, requestMessage.getImageURL(), requestMessage.getDirectoryPathname());

							// Send the path to the image file, url, and
							// requestCode back to the Activity via the
							// replyMessenger.
							// TODO -- DONE you fill in here.
							sendPath(messenger,imagePathname,url,requestCode);
						}
					};
